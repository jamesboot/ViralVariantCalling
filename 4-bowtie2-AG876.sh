...
#$ -l h_rt=240:0:0
#$ -l h_vmem=8G
#$ -N GC-AAA-10836_Bt2-AG876						# Change the name of the job accordingly
#$ -j y
#####
...
OUTPUT_DIR=${ANALYSISDIR}/3.bowtie2-AG876_results
GENOME=/data/WHRI-GenomeCentre/Genome/EBV2/bowtie2_index
